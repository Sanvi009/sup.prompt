...
export default async function handler(req, res) {
  ...
  if (action === 'users') {
    ...
    if (subAction === 'delete-comment') {
      ...
      // Get comment to update prompt count
